        ...
        <nav className="bg-white dark:bg-[#2F2F47] fixed w-full z-20 top-0 left-0 border-none h-20">
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                ...
                <div className="flex md:order-2 ">
                    ...
                    <button type="button" className="text-white h-8 ml-3 flex bg-gray-700 hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 mr-3 md:mr-0 dark:bg-gray-300 dark:hover:bg-gray-400 dark:focus:ring-gray-800">{state.length}<img src={Cart} className=' mb-2 h-8 align-center'/> </button>
